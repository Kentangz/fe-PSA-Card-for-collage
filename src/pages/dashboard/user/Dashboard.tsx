  ...
  useEffect(() => {
    ...
    const initializeDashboard = async () => {
      try {
        ...
        // Trust ProtectedRoute - minimal checks only
        ...
        const [cardsResponse, batchesResponse] = await Promise.all([
          axiosInstance.get<CardsResponse>("/user-cards").catch(() => ({ data: [] })),
          axiosInstance.get<BatchType[]>("/active-batches").catch(() => ({ data: [] }))
        ]);
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  <h5 className="text-base sm:text-lg font-medium text-gray-800">Batches</h5>
