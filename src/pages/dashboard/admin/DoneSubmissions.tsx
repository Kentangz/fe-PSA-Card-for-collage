...
export default function DoneSubmissions() {
          ...
          <div className="h-14 flex justify-between items-center px-2">
            <div className="flex items-center">
              ...
              <p className="text-lg lg:text-xl font-medium text-gray-800 truncate">
                <span className="hidden sm:inline">Done Submissions</span>
          ...
          <div className="mt-4 flex justify-center items-center h-64">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="text-red-500 text-center">
                ...
                <p className="text-lg font-medium mb-2">Error Loading Done Submissions</p>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="block lg:hidden">
              {loading ? (
                <div className="py-12 text-center text-gray-500">
                  ...
                  <p className="text-sm">Loading done submissions...</p>
                </div>
              ) : filteredSubmissions.length === 0 ? (
                <div className="py-12 text-center text-gray-500">
                  <div className="mx-auto h-12 w-12 text-green-300 mb-4 flex items-center justify-center">
                    ✓
                  </div>
                  {filters.searchTerm ? (
                    <div className="px-4">
                      <p className="text-lg font-medium mb-2">No done submissions found</p>
                      <p className="text-sm">Try adjusting your search criteria</p>
                    </div>
                  ) : (
                    <p className="text-base px-4">No completed submissions found</p>
                  )}
                </div>
              ) : (
            ...
            <div className="hidden lg:block">
              {loading && (
                <div className="py-12 text-center text-gray-500">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-green-600 mx-auto mb-4"></div>
                  <p className="text-base">Loading done submissions...</p>
                </div>
              )}
              
              {filteredSubmissions.length === 0 && !loading && (
                <div className="py-12 text-center text-gray-500">
                  <div className="mx-auto h-12 w-12 text-green-300 mb-4 flex items-center justify-center text-2xl">
                    ✓
                  </div>
                  {filters.searchTerm ? (
                    <div className="px-4">
